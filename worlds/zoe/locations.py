...
location_groups: dict[str, set[str]] = {
    ...
    ZOEREGION.TOWN_2: get_from_tag(ZOEREGION.TOWN_2),
    ZOEREGION.CITY_1: get_from_tag(ZOEREGION.CITY_1),
    ZOEREGION.EPS_1: get_from_tag(ZOEREGION.EPS_1),
    ZOEREGION.EPS_2: get_from_tag(ZOEREGION.EPS_2),
    ZOEREGION.TOWN_3: get_from_tag(ZOEREGION.TOWN_3),
    ZOEREGION.CITY_2: get_from_tag(ZOEREGION.CITY_2),
    ZOEREGION.PARK_1: get_from_tag(ZOEREGION.PARK_1),
    ZOEREGION.MOUNTAIN_1: get_from_tag(ZOEREGION.MOUNTAIN_1),
    ZOEREGION.MOUNTAIN_1_NEBULA: get_from_tag(ZOEREGION.MOUNTAIN_1_NEBULA),
    ZOEREGION.WAREHOUSE_1: get_from_tag(ZOEREGION.WAREHOUSE_1),
    ZOEREGION.TUNNEL_1: get_from_tag(ZOEREGION.TUNNEL_1),
    ZOEREGION.HUB_1: get_from_tag(ZOEREGION.HUB_1),
    ...
    ZOETAG.AMMO: get_from_tag(ZOETAG.AMMO),
    ZOETAG.RESCUE: get_from_tag(ZOETAG.RESCUE),
    }
