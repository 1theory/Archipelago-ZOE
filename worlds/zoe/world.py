...
class ZoeWorld(World):
    ...
    def fill_slot_data(self) -> dict[str, Any]:
        slot_data: dict[str, Any] = {
            ...
            ZOEOPTION.INFOS: self.options.infos.value,
            ZOEOPTION.DEATHLINK: self.options.deathlink.value,
            ZOEOPTION.EXCLUDE: self.options.exclude_locations.value,
            ZOEOPTION.TRAP_WEIGHT: self.options.trap_weight.value,
            ZOEOPTION.ENABLE_TRAPS: self.options.traps_enabled.value,
            ZOEOPTION.FILLER_WEIGHT: self.options.filler_weight.value,
            ZOEOPTION.WEAPONS: self.options.weapons.value,
            ZOEOPTION.ENEMY_COUNTER: self.options.enemy_counter.value,
            ZOEOPTION.VRTRAINING: self.options.vrtraining.value,
            ZOEOPTION.LOCAL_SERVERS: self.options.local_server.value,
            ZOEOPTION.PASSCODES_ITEMS: self.options.passcodes_items.value,
            ZOEOPTION.PASSCODES_LOCS: self.options.passcodes_locs.value,
            ZOEOPTION.CONFIGURATION: self.options.configuration.value,
