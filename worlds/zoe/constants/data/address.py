...
SAVE_DATA: list[ZOEADDRESSDATA] = [
    # Player Stats
    ZOEADDRESSDATA((ZOESTATUS.PLAYER_HEALTH, CHECKTYPE.SHORT, 0x44A0)),
    ZOEADDRESSDATA((ZOESTATUS.PLAYER_EXPERIENCE, CHECKTYPE.SHORT, 0)),
    ZOEADDRESSDATA((ZOESTATUS.PLAYER_LEVEL, CHECKTYPE.BYTE, 1)),
