...
class TestTempest(ZOETestBase):
    ...
    def test_logic(self):
        ...
        self.assertFalse(self.can_reach_region(ZOEREGION.CITY_1), "CITY.1 reachable from HANGAR.1")
        ...
        self.assertFalse(self.can_reach_region(ZOEREGION.CITY_1), "CITY.1 reachable from FACTORY.1")
        self.assertFalse(self.can_reach_location(ZOELOCATION.CITY_1_DESTROY_RELAY_BLOCK),
                         "Goal location reachable from FACTORY.1")
        self.assertBeatable(False)

        self.collect_by_name(ZOEITEM.CITY_1)
        self.assertTrue(self.can_reach_region(ZOEREGION.CITY_1), "Can't reach CITY.1")
        self.assertFalse(self.can_reach_location(ZOELOCATION.CITY_1_DESTROY_RELAY_BLOCK),
